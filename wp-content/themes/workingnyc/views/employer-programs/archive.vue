<template>
  <div>
    ...
    <div>
      <div class="shadow-[2px_2px_30px_0_#EFF1F5] desktop:shadow-none desktop:relative sticky top-0 z-10 bg-scale-0">
        <div class="site-max-width">
          <div 
            v-bind:class="'py-2 desktop:pt-7 flex desktop:flex-wrap overflow-x-auto gap-y-2 justify-start items-center ' 
            ...
            <template v-for="term in terms">
              <template v-for="filter in term.filters">
                <button class="small rounded p-1 bg-scale-2 mr-1 flex items-center bg-[#EFF1F5] hover:bg-[#DCDFEA] active:bg-[#DCDFEA] no-underline text-[#080707]" v-if="filter.checked" @click="click({event: $event, data: filter})">
                    ...
                    <svg width="16" height="16" class="icon-ui stroke-black mr-2 desktop:mr-0" tabindex="-1">
      ...
      <div class="site-max-width mb-5 tablet:mb-6 desktop:mb-7 mt-5 tablet:mt-6 desktop:mt-0" v-if="init" v-show="!filtersExpanded">
