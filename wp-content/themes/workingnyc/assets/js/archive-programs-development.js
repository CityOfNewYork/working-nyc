(function () {
	...
	var __vue_render__$1 = function () {
	  ...
	  return _c("div", [
	    _c(
	      ...
	      {
	        staticClass:
	          "c-dropdown c-dropdown-max layout-content sticky top-0 bg-scale-1 relative z-40",
	      },
	      [
	        _c("div", { staticClass: "c-utility wrap" }, [
	          _c("a", { staticClass: "link-icon mie-auto", attrs: { href: "/" } }, [
	            _c(
	              "svg",
	              {
	                staticClass: "icon-ui rtl:flip",
	                attrs: { "aria-hidden": "true" },
	              },
	              [_c("use", { attrs: { href: "#lucide-chevron-left" } })]
	            ),
	            _vm._v(" "),
	            _c("span", [_vm._v(_vm._s(_vm.strings.HOME))]),
	          ]),
	          _vm._v(" "),
	          _c(
	            "button",
	            {
	              staticClass: "btn btn-small btn-secondary light:btn-primary",
	              attrs: {
	                disabled: _vm.terms.length === 0,
	                "aria-controls": "aria-c-filter",
	                "aria-expanded": "false",
	                "data-dialog": "open",
	            ...
	            [
	              _c("span", { staticClass: "mie-1" }, [
	                _vm._v(_vm._s(_vm.strings.FILTERS)),
	              ]),
	              _vm._v(" "),
	              _c(
	                "span",
	                {
	                  staticClass:
	                    "badge badge-small status-secondary light:status-primary",
	                },
	                [_vm._v(_vm._s(_vm.totalFilters))]
	              ),
	            ]
	          ),
	        ]),
	        ...
	        _c(
	          ...
	          {
	            staticClass: "hidden",
	            attrs: { "aria-hidden": "true", id: "aria-c-filter" },
	          },
	          [
	            _c("div", { staticClass: "layout-content" }, [
	              _c("div", { staticClass: "wrap text-end relative z-20" }, [
	                _c(
	                  "button",
	                  {
	                  ...
	                  [
	                    _c(
	                      ...
	                      [_c("use", { attrs: { href: "#lucide-x" } })]
	                    ),
	                    _vm._v(" "),
	                    _c("span", [_vm._v(_vm._s(_vm.strings.CLOSE))]),
	                  ]
	                ),
	              ]),
	            ]),
	            _vm._v(" "),
	            _c("form", { attrs: { tabindex: "-1" } }, [
	              _c("div", { staticClass: "layout-content" }, [
	                _c(
	                  "div",
	                  _vm._l(_vm.terms, function (term) {
	                    return _c("div", { key: term.slug, staticClass: "mb-8" }, [
	                      _c(
	                        "fieldset",
	                        {
	                          staticClass: "fieldset mb-2",
	                          attrs: { tabindex: "-1" },
	                        },
	                        [
	                          _c(
	                            ...
	                            {
	                              staticClass:
	                                "h5 block w-full m-0 py-2 mb-1 tablet:py-3 pis-4 text-alt sticky top-0 z-10 bg-scale-1",
	                              attrs: { tabindex: "-1" },
	                            },
	                            [
	                              _vm._v(
	                          ...
	                          _c(
	                            ...
	                            {
	                              staticClass:
	                                "wrap grid gap-2 tablet:grid-cols-2 tablet:gap-3",
	                            },
	                            _vm._l(term.filters, function (filter) {
	                              return _c(
	                                "label",
	                                {
	                                  ...
	                                  attrs: { tabindex: "-1", "gtm-data": "test" },
	                                },
	                                [
	                                  _c("input", {
	                                  ...
	                                  _vm._v(" "),
	                                  _c("span", { staticClass: "option__base" }, [
	                                    _c(
	                                      "svg",
	                                      {
	                      ...
	                      _c("div", { staticClass: "pis-4" }, [
	                        _c("button", {
	                          ...
	                          attrs: {
	                            ...
	                            tabindex: "-1",
	                            "aria-pressed":
	                              term.filters.filter(function (f) {
	                                return f.checked
	                              }).length === term.filters.length
	                                ? "true"
	                                : "false",
	                          },
	                          domProps: {
	                            innerHTML: _vm._s(
	                              _vm.strings.TOGGLE_ALL.replace(
	                                "{{ TERM }}",
	              ...
	              _c(
	                ...
	                {
	                  staticClass:
	                    "layout-content shadow-up py-2 sticky bottom-0 z-10 text-center bg-scale-1",
	                },
	                [
	                  _c("div", { staticClass: "wrap" }, [
	                    _c("button", {
	                      staticClass: "btn btn-secondary w-full",
	                      attrs: {
	                        "aria-controls": "aria-c-filter",
	                        "aria-expanded": "false",
	                        "data-js": "dialog",
	                      ...
	                      domProps: {
	                        innerHTML: _vm._s(
	                          _vm.strings.CLOSE_AND_SEE_PROGRAMS.replace(
	                            "{{ number }}",
	                            _vm.headers.total
	                          )
	                        ),
	      ...
	      _c("div", { staticClass: "page-max" }, [
	        _c("header", { staticClass: "o-header" }, [
	          _c("div", [
	            _c(
	              ...
	              [
	                ...
	                _c(
	                  ...
	                  {
	                    staticClass:
	                      "o-header__breadcrumbs-chevron icon-ui rtl:flip",
	                    attrs: { "aria-hidden": "true" },
	                  },
	                  [_c("use", { attrs: { href: "#lucide-chevron-right" } })]
	                ),
	                _vm._v(" "),
	                _c("b", { attrs: { "aria-current": "page" } }, [
	            ...
	            _vm._v(" "),
	            _vm.strings.PAGE_CONTENT
	              ? _c("div", {
	                  staticClass: "mb-3",
	                  domProps: { innerHTML: _vm._s(_vm.strings.PAGE_CONTENT) },
	                })
	              : _vm._e(),
	          ]),
	        ]),
	    ...
	    _vm.init
	      ? _c("section", { staticClass: "page-max desktop:px-6" }, [
	          !_vm.loading
	            ? _c("div", { staticClass: "wrap desktop:px-6" }, [
	                ...
	                _c(
	                  ...
	                  {
	                    staticClass:
	                      "grid gap-3 tablet:grid-cols-2 desktop:gap-5 mb-3",
	                  },
	          ...
	          _vm.none
	            ? _c(
	                "div",
	                {
	                  staticClass: "flex items-center text-em justify-center py-4",
	                },
	                [
	                  _c("p", [
	    ...
	    _vm._v(" "),
	    _vm.init
	      ? _c("div", { staticClass: "layout-content py-6 pb-8 mb-4" }, [
	          _c("div", { staticClass: "wrap" }, [
	            _vm.next
	              ? _c(
	                  "button",
	                  {
	                    ...
	                    attrs: { id: "pagination", "data-amount": "1" },
	              ...
	              : _vm.strings.SUGGEST
	              ? _c("article", {
	                  staticClass: "c-alert mb-3",
	                  attrs: { "data-js": "alert-help" },
	                  domProps: { innerHTML: _vm._s(_vm.strings.SUGGEST) },
	                })
	              : _vm._e(),
	          ]),
	        ])
	    ...
	    _c(
	      ...
	      {
	        staticClass:
	          "layout-content pb-2 sticky z-10 o-navigation-feedback-spacing-bottom",
	      },
	      [
	        _c("div", { staticClass: "wrap text-end" }, [
	          _c(
	            "a",
	            {
	              staticClass: "btn btn-small tablet:btn btn-secondary",
	              attrs: { href: "#page-heading" },
	            },
	            [_vm._v(_vm._s(_vm.strings.BACK_TO_TOP))]
	          ),
	        ]),
	      ]
	    ),
	...
	var __vue_render__ = function () {
	  ...
	  return _c("article", { staticClass: "c-card" }, [
	    _c("header", { staticClass: "c-card__header" }, [
	      _c("span", [
	        _c(
	          "a",
	          {
	            staticClass: "c-card__header-link",
	            attrs: {
	              "data-js": "post-" + _vm.post.id,
	              href: _vm.post.context.link,
	              target: _vm.post.context.external ? "_blank" : false,
	              rel: _vm.post.context.external ? "noopener" : false,
	            },
	          },
	          [
	            _c("h3", { staticClass: "c-card__title" }, [
	              _c("span", {
	                staticClass: "c-card__underline",
	                domProps: {
	                  innerHTML: _vm._s(
	                    _vm.post.context.program_plain_language_title
	                  ),
	                },
	              }),
	              _vm._v(" "),
	              _vm.post.context.external
	                ? _c(
	                    "svg",
	                    {
	                      staticClass: "icon-ui rtl:flip",
	                    ...
	                    [_c("use", { attrs: { href: "#lucide-external-link" } })]
	                  )
	                : _vm._e(),
	            ]),
	          ]
	        ...
	        _vm._v(" "),
	        _c("p", { staticClass: "c-card__subtitle text-alt" }, [
	          _c("b", {
	            attrs: { "data-program": "title" },
	            domProps: { innerHTML: _vm._s(_vm.post.context.program_title) },
	          }),
	          _vm._v(" "),
	          _vm.post.context.program_agency
	            ? _c("span", [_vm._v(" " + _vm._s(_vm.strings.BY) + " ")])
	            : _vm._e(),
	          _vm._v(" "),
	          _vm.post.context.program_agency
	            ? _c("span", {
	                domProps: {
	                  innerHTML: _vm._s(_vm.post.context.program_agency),
	                },
	              })
	            : _vm._e(),
	        ]),
	    ...
	    _c("div", { staticClass: "c-card__body" }, [
	      _vm.post.status
	        ? _c("p", { staticClass: "c-card__status flex items-center" }, [
	            _vm.post.context.status.recruiting
	              ? _c(
	                  "mark",
	                  {
	                    staticClass: "badge mie-2",
	                    attrs: { "data-program": "recruiting" },
	                  },
	                  [
	                    _vm._v(
	                      "\n        " +
	              ...
	              : _vm._e(),
	            _vm._v(" "),
	            _vm.post.context.status.disability
	              ? _c("span", { staticClass: "flex mie-2" }, [
	                  _c(
	                    "svg",
	                    { staticClass: "icon text-em", attrs: { role: "img" } },
	                    [
	                      _c("title", {
	                        domProps: {
	                          innerHTML: _vm._s(
	                            _vm.post.context.status.disability.name
	                          ),
	                        },
	                      }),
	                      _vm._v(" "),
	                      _c("use", { attrs: { href: "#nyco-accessibility" } }),
	                    ]
	                  ),
	                ])
	              : _vm._e(),
	            ...
	            _vm.post.context.status.disability
	              ...
	              : _vm._e(),
	            _vm._v(" "),
	            _vm.post.context.status.language
	              ? _c("span", { staticClass: "flex me-2" }, [
	                  _c(
	                    "svg",
	                    { staticClass: "icon-ui text-em", attrs: { role: "img" } },
	                    [
	                      _c("title", {
	                        domProps: {
	                          innerHTML: _vm._s(
	                            _vm.post.context.status.language.name
	                          ),
	                        },
	                      }),
	                      _vm._v(" "),
	                      _c("use", { attrs: { href: "#nyco-languages" } }),
	                    ]
	                  ),
	                ])
	              : _vm._e(),
	      ...
	      _c("div", { staticClass: "c-card__summary" }, [
	        _c("p", [
	          _vm.post.context.preview
	            ? _c("span", {
	                domProps: { innerHTML: _vm._s(_vm.post.context.preview) },
	              })
	            : _vm._e(),
	          _vm._v(" "),
	          _vm.post.context.populations
	            ? _c("span", {
	                domProps: { innerHTML: _vm._s(_vm.post.context.populations) },
	              })
	            : _vm._e(),
	        ]),
	      ]),
	      _vm._v(" "),
	      _c("ul", { staticClass: "c-card__features" }, [
	        _vm.post.context.services
	          ? _c("li", [
	              _c(
	                "svg",
	                {
	                  staticClass: "icon-ui c-card__feature-icon",
	                  attrs: { role: "img" },
	                },
	                [
	                  _c("title", [_vm._v(_vm._s(_vm.strings.SERVICES))]),
	                  _vm._v(" "),
	                  _c("use", { attrs: { href: "#lucide-award" } }),
	                ]
	              ),
	              _vm._v(" "),
	              _c("span", {
	                domProps: { innerHTML: _vm._s(_vm.post.context.services) },
	              }),
	            ])
	          : _vm._e(),
	        _vm._v(" "),
	        _vm.post.context.schedule
	          ? _c("li", [
	              _c(
	                "svg",
	                {
	                ...
	                [
	                  _c("title", [_vm._v(_vm._s(_vm.strings.SCHEDULE))]),
	                  _vm._v(" "),
	                  _c("use", { attrs: { href: "#lucide-calendar" } }),
	                ]
	              ),
	              _vm._v(" "),
	              _c("span", {
	                domProps: { innerHTML: _vm._s(_vm.post.context.schedule) },
	              }),
	            ])
	          : _vm._e(),
	        _vm._v(" "),
	        _vm.post.context.supports
	          ? _c("li", [
	              _c(
	                "svg",
	                {
	                ...
	                [
	                  _c("title", [_vm._v(_vm._s(_vm.strings.SUPPORTS))]),
	                  _vm._v(" "),
	                  _c("use", { attrs: { href: "#lucide-heart-handshake" } }),
	                ]
	              ),
	              _vm._v(" "),
	              _c("span", {
	                domProps: { innerHTML: _vm._s(_vm.post.context.supports) },
	              }),
	            ])
	          : _vm._e(),
	      ]),
	      ...
	      _c(
	        ...
	        [
	          _vm.post.context.external
	            ? _c("span", {
	                domProps: { innerHTML: _vm._s(_vm.post.context.link_label) },
	              })
	            : _c("span", {
	                domProps: {
	                  innerHTML: _vm._s(
	                    _vm.strings.LEARN_MORE_ABOUT.replace(
	                      "{{ program }}",
	                      _vm.post.context.program_plain_language_title
	                    )
	                  ),
	          ...
	          _c(
	            ...
	            [
	              _c("use", {
	                attrs: {
	                  href: _vm.post.context.external
