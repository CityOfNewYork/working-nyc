(function () {
	...
	*/
	...
	var vue_common_prod = createCommonjsModule(function (module) {
	...
	unwrapExports(vue_common_prod);

	var vue_common = createCommonjsModule(function (module) {
	{
	  module.exports = vue_common_prod;
	}
	});
	...
	Programs.getTax = function () {
	  ...
	  var promises = this.taxonomies.map(function (x) {
	    return "".concat(_this3.baseUrl).concat(Object.keys(x)[0], "?hide_empty=true&per_page=100");
	  });
	  return promises;
	};
	/**
