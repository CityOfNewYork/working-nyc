(function () {
	...
	/* template */
	var __vue_render__$1 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('h2',{staticClass:"text-p font-p inline-block m-0",attrs:{"data-alert":"text","aria-live":"polite"}},[_c('span',{domProps:{"innerHTML":_vm._s(_vm.strings.SHOWING.replace('{{ TOTAL_VISIBLE }}', _vm.totalVisible).replace('{{ TOTAL }}', _vm.headers.total))}})]),_vm._v(" "),_c('div',_vm._l((_vm.postsFlat),function(post){return _c('span',{key:post.id,attrs:{"post":post,"strings":_vm.strings}},[_vm._v(" "+_vm._s(post.id)+" ")])}),0),_vm._v(" "),_c('section',{staticClass:"px-4 tablet:px-6"},[_c('div',{staticClass:"grid gap-3 tablet:grid-cols-2 desktop:gap-5 mb-3"},_vm._l((_vm.postsFlat),function(post){return _c('SearchResult',{key:post.id,attrs:{"post":post,"strings":_vm.strings}})}),1),_vm._v(" "),(_vm.init)?_c('div',{staticClass:"layout-content py-6 pb-8 mb-4"},[_c('div',{staticClass:"wrap"},[(_vm.next)?_c('button',{staticClass:"btn btn-primary w-full",attrs:{"id":"pagination","data-amount":"1"},on:{"click":_vm.nextPage}},[_vm._v("\n          "+_vm._s(_vm.strings.SHOW_MORE)+"\n        ")]):_vm._e()])]):_vm._e()])])};
