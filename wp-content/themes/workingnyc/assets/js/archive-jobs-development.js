	  ...
	  return _c("div", [
	    ...
	    _vm.init
	      ? _c(
	          "section",
	          {
	            staticClass: "page-max desktop:px-6",
	            attrs: { "data-js": "posts" },
	          },
	          [
	            !_vm.loading
	  ...
	  return _c("article", { staticClass: "c-card" }, [
	      ...
	      _c("span", [
	        _c(
	          "a",
	          {
	            ...
	            attrs: { "data-js": "post-" + _vm.post.id, href: _vm.post.link },
	          },
	          [
	            _c("h3", { staticClass: "c-card__title" }, [
	              _c("span", {
	                staticClass: "c-card__underline",
	                domProps: { innerHTML: _vm._s(_vm.post.context.cardTitle) },
	              }),
	            ]),
	          ]
	        ),
	        ...
	        _c("p", { staticClass: "c-card__subtitle text-alt" }, [
	          _vm.post.context.sector
	            ? _c("b", {
	                domProps: { innerHTML: _vm._s(_vm.post.context.sector) },
	              })
	            : _vm._e(),
	          _vm._v(" "),
	          _vm.post.context.sector && _vm.post.context.organization
	            ? _c("span", [_vm._v(" " + _vm._s(_vm.strings.WITH) + " ")])
	            : _vm._e(),
	          _vm._v(" "),
	          _c("span", {
	            domProps: { innerHTML: _vm._s(_vm.post.context.organization) },
	          }),
	        ]),
	      ]),
	    ]),
	    ...
	    _c("div", { staticClass: "c-card__body" }, [
	      _c("div", { staticClass: "c-card__summary" }, [
	        _c("p", { domProps: { innerHTML: _vm._s(_vm.post.context.summary) } }),
	      ]),
	      _vm._v(" "),
	        ...
	        _vm.post.context.salary
	          ? _c("li", [
	              _c(
	                ...
	                [
	                  _c("title", [_vm._v(_vm._s(_vm.strings.SALARY))]),
	                  _vm._v(" "),
	                  _c("use", { attrs: { href: "#lucide-dollar-sign" } }),
	                ]
	              ),
	              _vm._v(" "),
	              _c("span", {
	                domProps: { innerHTML: _vm._s(_vm.post.context.salary) },
	              }),
	            ])
	          : _vm._e(),
	        _vm._v(" "),
	        _vm.post.context.location
	          ? _c("li", [
	              _c(
	                "svg",
	                {
	                ...
	                [
	                  _c("title", [_vm._v(_vm._s(_vm.strings.LOCATION))]),
	                  _vm._v(" "),
	                  _c("use", { attrs: { href: "#lucide-map-pin" } }),
	                ]
	              ),
	              _vm._v(" "),
	              _c("span", {
	                domProps: { innerHTML: _vm._s(_vm.post.context.location) },
	              }),
	            ])
	          : _vm._e(),
	      ]),
	      _vm._v(" "),
	      _c("a", { staticClass: "c-card__cta", attrs: { href: _vm.post.link } }, [
	        _c(
	          "svg",
	          { staticClass: "icon-ui rtl:flip", attrs: { "aria-hidden": "true" } },
	          [_c("use", { attrs: { href: "#lucide-arrow-left" } })]
	        ),
	        _vm._v(" "),
	        _c("span", {
	          domProps: {
	        ...
	        _c(
	          "svg",
	          { staticClass: "icon-ui rtl:flip", attrs: { "aria-hidden": "true" } },
	          [_c("use", { attrs: { href: "#lucide-arrow-right" } })]
	        ),
	      ]),
	      _vm._v(" "),
	      _vm.post.raw
